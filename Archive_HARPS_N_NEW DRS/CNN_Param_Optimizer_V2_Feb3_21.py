...
LOG_DIR_4 = "CNN_tensorlogs_Feb2_21/" + time.strftime("%Y%m%d-%H%M%S", time.localtime())
#print(LOG_DIR_4)
...
for i in trange(0,2):#30):
      ...
      with tf.summary.create_file_writer(run_dir).as_default():
          ...
          metric_values = train_cross_val(model, hparams, plots="OFF", model_name = "CNN",num_epochs=epochs)#np.random.choice(num_epochs_list))
