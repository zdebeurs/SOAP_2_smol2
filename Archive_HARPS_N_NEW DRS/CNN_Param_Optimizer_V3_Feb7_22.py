...
learning_rate_list = [10**-x][0]#[10**-exp_list[0], 10**-exp_list[1], 10**-exp_list[2]]
...
LOG_DIR_1 = "CNN_tensorlogs/" + time.strftime("%Y%m%d-%H%M%S", time.localtime())
#print(LOG_DIR_4)
...
for model_num in range(1,101):#30):
      rms_avg_list = []
      weight_decay_list_t = []
